...
class JeadCopyDependenciesTaskTest extends AbstractJeadGradleTaskTest {
    ...
    void testCopyDependenciesExecution() throws IOException {
        ...
        BuildResult result = runTask(JeadGradlePlugin.COPY_DEPENDENCIES_TASK);

        assertTaskOutcome(result, JeadGradlePlugin.COPY_DEPENDENCIES_TASK, TaskOutcome.SUCCESS);
    ...
    void testCopyDependenciesCustomOutputDirectory() throws IOException {
        String extraConfig = String.format("%s {\n" +
                ...
                "}\n", JeadGradlePlugin.COPY_DEPENDENCIES_TASK);
