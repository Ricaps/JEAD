...
import cz.muni.fi.jead.model.ProjectModel;
import cz.muni.fi.jead.plugin.delombok.Constants;
import cz.muni.fi.jead.plugin.delombok.DelombokExecutor;
import cz.muni.fi.jead.plugin.delombok.DelombokExecutorException;
 ...
 */
public abstract class JeadDelombokTask extends DefaultTask {

    private static final String DELOMBOK_SUFFIX = "delombok";

    public JeadDelombokTask() {
