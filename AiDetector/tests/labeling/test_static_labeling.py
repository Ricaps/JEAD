...
class JsonDeduplicateTest(unittest.TestCase):
    ...
    def test_positive_regexes_matches(self):
        labeler = StaticRuleLabeling(labeled_attribute=LABELED_ATTRIBUTE, positive_rules=[self.TODO_REGEX])
    ...
    def test_positive_not_matches_negative_matches(self):
        labeler = StaticRuleLabeling(labeled_attribute=LABELED_ATTRIBUTE, positive_rules=[self.NOT_MATCHING_REGEX],
    ...
    def test_multiple_regexes_matches(self):
        labeler = StaticRuleLabeling(labeled_attribute=LABELED_ATTRIBUTE,
