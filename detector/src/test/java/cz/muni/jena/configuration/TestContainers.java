...
public class TestContainers {
    ...
    public static final int DATABASE_SERVICE_PORT = 54323;
    ...
    public static final int INFERENCE_SERVICE_PORT = 54321;
    ...
    public static ComposeContainer getComposeContainer() {
        return new ComposeContainer(
                ...
                .withExposedService(DATABASE_SERVICE_NAME, DATABASE_SERVICE_PORT).withEnv(MODELS_ROOT_ENV, MODELS_ROOT_ENV_VALUE)
