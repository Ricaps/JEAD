...
@Component
public class JeadMavenPluginInitializer {
    ...
    private final Logger LOGGER = LoggerFactory.getLogger(JeadMavenPluginInitializer.class);
    private final PreparePluginConfig preparePluginConfig;

    public JeadMavenPluginInitializer(PreparePluginConfig preparePluginConfig) {
